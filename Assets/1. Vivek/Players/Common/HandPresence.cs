...
namespace Utils
{
    public class HandPresence : MonoBehaviour
    {
        ...
        public void OnHandSelectEnter(SelectEnterEventArgs args)
        {
            ...
            CustomSimpleInteractable customSimpleInteractable = args.interactable as CustomSimpleInteractable;
            if (customSimpleInteractable)
            {
                toolName = customSimpleInteractable.animNameToPlay;
                handAnimator.SetBool(IS_HAND_OPEN, false);
                if (customSimpleInteractable.ShouldUseDefaultFistAnim)
                    handAnimator.Play(FIST);
                else
                {
                    handAnimator.Play(toolName);
