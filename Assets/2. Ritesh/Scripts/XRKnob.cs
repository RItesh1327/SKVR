...
public class XRKnob : XRBaseInteractable
{
    ...
    [SerializeField]
    [Tooltip("Reference to the Particle System to control")]
    ...
    [SerializeField]
    [Tooltip("Maximum emission rate of the particle system")]
    ...
    void UpdateParticleSystem()
    {
        if (particle != null) // Check if the Particle System reference is not null
        {
            ...
            float lerpedEmissionRate = Mathf.Lerp(maxEmissionRate, 0f, m_Value);
            ...
            if (m_Value > 0.95f && knoboff == false)
            {
